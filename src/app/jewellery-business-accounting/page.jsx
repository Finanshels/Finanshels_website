...
export const metadata = serviceRouteMetadata('/jewellery-business-accounting', SECTOR_PAGES['jewellery-business-accounting'])

export default async function Page() {
  const cmsTestimonials = await getTestimonials({ limit: 12 })
  return <ServiceDetailPage page={SECTOR_PAGES['jewellery-business-accounting']} cmsTestimonials={cmsTestimonials} />
}
