...
export const metadata = serviceRouteMetadata('/vat-filing-uae', SERVICE_PAGES['vat-filing-uae'])

export default async function Page() {
  const cmsTestimonials = await getTestimonials({ service: 'vat', limit: 12 })
  return <ServiceDetailPage page={SERVICE_PAGES['vat-filing-uae']} cmsTestimonials={cmsTestimonials} />
}
