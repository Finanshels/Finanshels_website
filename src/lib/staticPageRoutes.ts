...
export const LEGACY_STATIC_ROUTES = [
  ...
  '/aml-compliance-uae',  '/order-successful-page',
  '/cfo-event-by-finanshels',  '/landing-pages/aml-compliance-filing-in-uae-with-finanshels',
  ...
  '/landing-pages/vat-filing-for-your-business-desk',  '/the-2025-aml-playbook-webinar-finanshels',
