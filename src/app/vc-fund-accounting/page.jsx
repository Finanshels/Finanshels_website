...
export const metadata = serviceRouteMetadata('/vc-fund-accounting', SECTOR_PAGES['vc-fund-accounting'])

export default async function Page() {
  const cmsTestimonials = await getTestimonials({ limit: 12 })
  return <ServiceDetailPage page={SECTOR_PAGES['vc-fund-accounting']} cmsTestimonials={cmsTestimonials} />
}
