...
export const metadata = serviceRouteMetadata('/small-business-accounting', SECTOR_PAGES['small-business-accounting'])

export default async function Page() {
  const cmsTestimonials = await getTestimonials({ limit: 12 })
  return <ServiceDetailPage page={SECTOR_PAGES['small-business-accounting']} cmsTestimonials={cmsTestimonials} />
}
