...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'Every transaction correctly coded, filed before the 28th every quarter. If we miss the deadline or get it wrong, we cover the penalty.',
    url: '/vat-filing-uae',
    type: 'website',
  },
}
...
export default function Page() {
  return <ServiceDetailPage page={SERVICE_PAGES['vat-filing-uae']} />
}
